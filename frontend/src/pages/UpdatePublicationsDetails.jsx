    ...
    return (
        <div className="grid grid-cols-6 mt-20">
            ...
            <div className="col-span-5 bg-white py-5 px-16 rounded-lg shadow-lg">
                <h1 className="text-3xl font-bold text-gray-700 mb-8 underline">Publications Details</h1>
                <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                    {/* ✅ Event Name Selection */}
                    <div className="">
                      
                        <label className="block text-lg font-bold text-gray-700">Publications Title *</label>
                    ...
                    <div className="">
                        <label className="block text-lg font-bold text-gray-700 mt-6">Authors *</label>
                    ...
                    <Input1 labelText="Journal / Conference *" name="role" value={formData.role} onChange={handleChange} required/>
                    </div>


                    <div className="flex flex-col gap-8">
                    <div className="flex flex-col gap-2">
                    <label className="block text-md font-semibold text-gray-700 ">Upload Publications *</label>
