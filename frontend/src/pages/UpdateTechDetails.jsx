...
import { fetchEventNames, fetchEventCategories } from "../api1";
...
const UpdateTechDetails = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post(
                "http://localhost:8080/api/technical-details/add",
                formDataToSend,
                {
                ...
                <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                    ...
                    <div>
                        ...
                        <select 
                            ...
                            required 
                            className="w-1/4 px-4 py-2 mt-2 mb-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
