    ...
    return (
        <div className="grid grid-cols-6 mt-20">
            ...
            <div className="col-span-5 bg-white py-5 px-16 rounded-lg shadow-lg">
                <h1 className="text-3xl font-bold text-gray-700 mb-8 underline">Professional Events Details</h1>
                <form onSubmit={handleSubmit} className="mt-5 space-y-4">
                    ...
                    <Input1 labelText="Achievement Details (if any)" name="achievementDetails" value={formData.achievementDetails} onChange={handleChange} />
